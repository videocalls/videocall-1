...
angular.module("oppf2").register.controller("AccountAddStep022Pop", function($scope, $koscomState, $stateParams, $koscomBridge, $koscomPopup){
    var vm = this;
    
    var appParams=$stateParams.appParams||{}; //앱신청,신청정보 수정으로 들어왔을 경우
    
    vm.customerRealaccountType = "";
    vm.realAccNo = "";
    ...
    vm.save = function(){
    	console.log(vm.realAccType);
    	
    	var realAccNo   = vm.realAccNo						//	실계좌번호
    	var realAccType = vm.realAccType;					//	구분
	...
	$koscomBridge.req("ACC_01_072",{"companyProfileRegNo":$stateParams.companyProfileRegNo,"companyCodeId":$stateParams.companyCodeId}).then(function(res){
