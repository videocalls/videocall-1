angular.module("koscomAngular").register.directive("tabs", function($ionicScrollDelegate){
	return {
		restrict: "A",
...
angular.module("koscomAngular").register.directive("tabs2", function($ionicScrollDelegate){
	return {
		restrict: "A",
		link: function($scope, elem, attrs){
