                ...
                <div class="main_con">
                                ...
                                <ul>
		                           <li class="icon1">
		                              <div>
		                                  ...
		                                  <a href="javascript:util_movePage('<c:url value='/usr/mbrReg/mbrReg.do'/>');">
			                              </c:if>
		                           ...
		                           <li class="icon2"><div><a href="javascript:fn_moveMenu('<c:url value="/myp/cert/cert.do"/>', '05003');"><span>공인인증서 등록</span></a></div></li>
		                           <li class="icon3"><div><a href="javascript:fn_moveMenu('<c:url value="/usr/svcAppl/asumAcntIsu.do"/>', '06001');"><span>가상계좌발급</span></a></div></li>
		                           <li class="icon4"><div><a href="javascript:fn_moveMenu('<c:url value="/usr/svcAppl/asumAcntIsu.do"/>', '06001');"><span>핀테크서비스 선택</span></a></div></li>
		                        </ul>
                            </dd>
                        </dl>   
                    </div>      
                    <div class="m_box4">
                        <dl>
                            ...
                            <dd>
                                <ul>
                                    <li class="icon1"><div><a href="mailto:master@koscom.openplatform.com">문의하기</a></div></li>
...
<!--                                <li><div><a href="http://www.iprovest.com/" target="_blank" title="새창열림"><img src="<c:url value="/images/spt/main/img_banner_15.jpg"/>" alt="교보증권"></a></div></li>  -->
                                ...
                                <li><div><a href="http://www.winnet.co.kr" target="_blank" title="새창열림"><img src="<c:url value="/images/spt/main/img_banner_02.jpg"/>" alt="동부증권"></a></div></li>
...
<!--                                <li><div><a href="http://www.shinyoung.com/index_et.html" target="_blank" title="새창열림"><img src="<c:url value="/images/spt/main/img_banner_22.jpg"/>" alt="신영증권"></a></div></li>  -->
                                ...
                                <li><div><a href="http://www.sks.com" target="_blank" title="새창열림"><img src="<c:url value="/images/spt/main/img_banner_13.jpg"/>" alt="SK증권"></a></div></li>
...
<!--                                <li><div><a href="http://www.yhs.co.kr/" target="_blank" title="새창열림"><img src="<c:url value="/images/spt/main/img_banner_27.jpg"/>" alt="유화증권주식회사"></a></div></li>  -->
                                ...
                                <li><div><a href="http://www.kbsec.co.kr/index.jsp" target="_blank" title="새창열림"><img src="<c:url value="/images/spt/main/img_banner_28.jpg"/>" alt="KB투자증권"></a></div></li>
