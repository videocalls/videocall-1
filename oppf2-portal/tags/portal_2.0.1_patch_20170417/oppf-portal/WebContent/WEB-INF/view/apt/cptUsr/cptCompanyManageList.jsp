...
$(document).ready(function(){
    ...
    gfn_gridOption('jqxgrid',{    
		columns: [
            { text: '기업이름 (한글약어)', datafield: 'companyNameKorAlias', width: '15%', cellsalign: 'left', align: 'center' },
            { text: '기업이름 (영문약어)', datafield: 'companyNameEngAlias', width: '15%', cellsalign: 'left', align: 'center' },
            { text: '기업코드', datafield: 'companyCodeId', width: '10%', cellsalign: 'left', align: 'center' },
            { text: '기업역할', datafield: 'companyServiceTypeName', width: '10%', cellsalign: 'center', align: 'center' },
            //{ text: '사업자등록번호', datafield: 'companyBizregNo', width: '15%', cellsalign: 'left', align: 'center' },
            { text: '가상계좌 발급여부', datafield: 'issueVtaccountName', width: '10%', cellsalign: 'center', align: 'center' },
            { text: '실계좌목록조회 여부', datafield: 'issueAccountlistName', width: '10%', cellsalign: 'center', align: 'center' },
