...
public interface CptStatsTrafficService{
    ...
    List<CptStatsTrafficVO> selectStatsTrafficApiNameListForApp(CptStatsTrafficVO cptStatsTrafficVO) throws Exception;

    List<CptStatsTrafficVO> selectStatsTrafficSubCompanyListForApi(CptStatsTrafficVO cptStatsTrafficVO) throws Exception;
}
