...
public class CmmArsController {
    ...
    private static final Logger log = Logger.getLogger(CmmArsController.class);
	...
	private static final String AUTH_INQUERY = "안녕하세요 코스콤입니다. ÐcustomerName 고객님의."
		+"ÐrsPubcompanyList 금융거래정보를 코스콤의 자본시장 공동 오픈플랫폼을 통해 전달하고 이를 동의한 날로부터 1년간 "
