...
$(document).ready(function(){
    ...
    if($("#schDateType").val() != "all"){
        $("#schDateFrom").datepicker("option", "disabled", false);
        $("#schDateTo").datepicker("option", "disabled", false);
        $("#schDateFrom").attr('readonly','readonly');
        $("#schDateTo").attr('readonly','readonly');
        $("input[name=schDateRdo]").prop("disabled", false);

        $("#schDateFrom").val('${SptUserManageVO.searchDateFrom}');
        $("#schDateTo").val('${SptUserManageVO.searchDateTo}');
    }else{
        $("#schDateType").val("all")
        $("#schDateFrom").val("");
        $("#schDateTo").val("");
        $("#schDateFrom").datepicker("option", "disabled", true);
        $("#schDateTo").datepicker("option", "disabled", true);
        $("#schDateFrom").removeAttr('readonly');
        $("#schDateTo").removeAttr('readonly');
        $("input[name=schDateRdo]").prop("disabled", true);
    }
	...
	// start date 변경
    $("#schDateFrom").focusout(function() {
        setEndDate("date");
    });
    // end date 변경
    $("#schDateTo").focusout(function() {
        setEndDate("date");
    });
...
function setEndDate(eventType) {
    ...
    var schDateFrom = $.trim(util_replaceAll($("#schDateFrom").val(), "-", ""));
    var schDateTo = $.trim(util_replaceAll($("#schDateTo").val(), "-", ""));
 
        if(!isFromToDate(schDateFrom, schDateTo, "00", "00")) {
            $("#schDateTo").val(util_setFmDate(schDateFrom));
        }
}
