 ...
 * 전역 변수
 *******************************************/
var g_initCheckboxArr = ["searchPubcompanyCodeId","searchCustomerRegStatus","searchCustomerVtaccountStatus"];
...
/*         if(util_chkReturn($.trim($('#searchDateTo').val()), "s") != "") {
    ...
    gfn_gridOption('jqxgrid',{    
		columns: [
            ...
            { text: '유형', datafield: 'customerRealaccountTypeName', width: '7%', cellsalign: 'center', align: 'center' },
