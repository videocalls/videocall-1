...
<%  
    ...
    String filename = java.net.URLEncoder.encode("FIX Engine 통계[Response기준]_"+date+".xls","UTF-8");
    //다운로드하고자 한다면 
   ...
   <table border="1">
       ...
       <tr>
           ...
           <c:choose>
               ...
               <c:otherwise>
                   <c:forEach var="chartDisplayNames" items="${chartDisplayNames}" varStatus="status">
                       <th scope="col" colspan="1" style="width:100px;"><c:out value="${chartDisplayNames.displayText}" /></th>
                   </c:forEach>
               </c:otherwise>
           </c:choose>
       </tr>
...
%>
                <tr>
                   <td class="txt_l" align="center"><%= data.get("resultDt") %></td>
                       ...
                       %>
                           <td class="txt_l" align="right"><%= data.get("resultCnt"+dataFieldName) %></td>
