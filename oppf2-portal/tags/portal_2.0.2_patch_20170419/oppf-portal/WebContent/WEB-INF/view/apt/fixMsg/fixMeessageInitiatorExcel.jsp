...
<head>
    <%--
    /**
     * @Name : fixMeessageInitiatorExcel.jsp
     * @Description : [FIX Message]Initiator Excel 목록
    ...
    <%
        ...
        String filename = java.net.URLEncoder.encode("Initiator_Fix_Message"+date+".xls","UTF-8");
        //다운로드하고자 한다면
