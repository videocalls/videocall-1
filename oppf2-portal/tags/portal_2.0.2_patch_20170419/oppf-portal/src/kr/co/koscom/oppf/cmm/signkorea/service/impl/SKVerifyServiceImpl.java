...
public class SKVerifyServiceImpl implements SKVerifyService{
    ...
    public int verifySign(String verifyd_ip, int verifyd_port, SKSignedDataInfo result){
        ...
        try{
            ...
            System.err.println("Don't know about host: " + verifyd_ip );
            return -1;
        }catch (IOException e){
            System.err.println("Couldn't get I/O for the connection to: " + verifyd_ip);
            return -2;
        }
    ...
    public int cipher(String demon_ip, int demon_port, SKCipherInfo cipherInfo)
    {
        ...
        {
            System.err.println("Don't know about host: " + demon_ip );
            return -1;
        }
        catch (IOException e)
        {
            System.err.println("Couldn't get I/O for the connection to: " + demon_ip);
            return -2;
        }
    ...
    public int verifySignExt(String verifyd_ip, int verifyd_port, SKSignedDataInfo result, SKVerifyExtInfo ext)
    {
        ...
        try
        {
            ...
            if(ret_opcode != result.opcode)
            {
                ...
                System.err.println("result.opcode" + result.opcode);
                System.err.println("recv SK_VERIFY_REP error 1");
                out.close();
                in.close();
                sock.close();
