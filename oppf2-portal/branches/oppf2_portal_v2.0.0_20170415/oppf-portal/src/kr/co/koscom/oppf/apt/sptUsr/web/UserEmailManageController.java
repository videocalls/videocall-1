...
public class UserEmailManageController {
	...
	private static final Logger log = Logger.getLogger(UserEmailManageController.class);
...
//        model.addAttribute("result", result);
        ...
        cmmEmailSendVO.setReceiverName(aptUserEmailManageVO.getReceiverNmae()); //받는 사람 이름(실제 이메일에 셋팅됩니다.)
...
//        model.addAttribute("result", result);
        ...
        if(resultSearchVO != null){
        	receiverName = resultSearchVO.getReceiverNmae();
