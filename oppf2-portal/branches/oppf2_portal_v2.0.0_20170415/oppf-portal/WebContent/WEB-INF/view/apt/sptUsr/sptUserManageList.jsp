...
$(document).ready(function(){
    ...
    gfn_gridOption('jqxgrid',{    
		columns: [
            ...
            { text: '계정상태', datafield: 'customerRegStatusName', width: '10%', cellsalign: 'left', align: 'center' },
            { text: '회원가입 Step', datafield: 'customerStepName', width: '11%', cellsalign: 'left', align: 'center' },
            { text: '등록일', datafield: 'createDate', width: '12%', cellsalign: 'center', align: 'center' },
            { text: '수정일', datafield: 'updateDate', width: '12%', cellsalign: 'center', align: 'center' },
            { text: '삭제일', datafield: 'deleteDate', width: '12%', cellsalign: 'center', align: 'center' },
