                ...
                <div class="tb_write1">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="txt_l">
                                <select title="구분 입력" id="faqKind" name="faqKind">
                                <c:forEach items="${faqKindList}" var="faqKindList" varStatus="status">
                                    <option value="${faqKindList.system_code}"
                                        <c:if test="${resultDetail.faqKind eq faqKindList.system_code}"> selected="selected" </c:if>
                                    >${faqKindList.code_name_kor}</option>
                                </c:forEach>
                            </td>                  
                        </tr>
