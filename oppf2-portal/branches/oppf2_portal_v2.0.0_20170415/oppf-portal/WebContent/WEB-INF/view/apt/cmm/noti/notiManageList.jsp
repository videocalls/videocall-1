...
$(document).ready(function(){
    ...
    gfn_gridOption('jqxgrid',{    
        columns: [
            { text: '고정여부', datafield: 'noticeFixYn', width: '5%', cellsalign: 'center', align: 'center' },
            { text: '노출종류', datafield: 'noticeKindName', width: '7%', cellsalign: 'center', align: 'center' },
            { text: '팝업여부', datafield: 'noticePopYn', width: '5%', cellsalign: 'center', align: 'center' },
            { text: '사용여부', datafield: 'useYn', width: '5%', cellsalign: 'center', align: 'center' },
            { text: '제목', datafield: 'noticeTitle', width: '43%', cellsalign: 'left', align: 'center' },
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="txt_l"> 
                                ...
                                <input type="radio" id="searchUseYn_Y" name="searchUseYn" value="Y" /><label for="searchUseYn_Y"> 팝업 </label>
                                <input type="radio" id="searchUseYn_N" name="searchUseYn" value="N" /><label for="searchUseYn_N"> 일반 </label>
                            </td>                           
                        </tr>
                        <tr>
