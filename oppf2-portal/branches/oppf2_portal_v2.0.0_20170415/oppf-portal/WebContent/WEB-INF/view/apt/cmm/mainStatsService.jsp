...
function fn_search(){
    ...
    //금융투자 핀테크 포털 회원 가입 현황 요약
    fn_searchSptUserList();
    
    //기업/금투사 포털 회원 가입 현황 요약
...
function fn_searchUserAccountListCallBack(data){
    ...
    if(util_chkReturn(resultList, "s") != ""){
        $.each(resultList, function(idx, list){
            ...
            html += "<td>";
            html += util_setCommas(list.accountCntAcc) + " 명";
            html += "</td>";
            html += "<td>";
            html += util_setCommas(list.accountCntYday) + " 명";
            html += "</td>";
...
<h3 style="margin-top: 30px;">금융투자 핀테크 포털 회원 가입 현황 요약 <span class="statsDayStd"></span></h3>
<div class="tb_list1">
    <table>
...
<h3 style="margin-top: 30px;">기업/금투사 포털 회원 가입 현황 요약 <span class="statsDayStd"></span></h3>
<div class="tb_list1">
    <table>
        <caption>누적회원, 전월 신규가입회원 정보</caption>
        <colgroup>
