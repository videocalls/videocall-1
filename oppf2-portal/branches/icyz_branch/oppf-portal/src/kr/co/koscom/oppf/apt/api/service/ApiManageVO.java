...
* @FileName : ApiManageVO.java
* @Comment  : api 관리를 위한 VO
* @author   : 신동진
* @since    : 2016.05.27
* @version  : 1.0
*
...
public class ApiManageVO extends ComDefaultListVO{
	/**
	 * com_api_view
	 */
	...
	private String apiUserConfirmYn;
	...
	public String getApiUserConfirmYn() {
		return apiUserConfirmYn;
	}
	public void setApiUserConfirmYn(String apiUserConfirmYn) {
		this.apiUserConfirmYn = apiUserConfirmYn;
	}
