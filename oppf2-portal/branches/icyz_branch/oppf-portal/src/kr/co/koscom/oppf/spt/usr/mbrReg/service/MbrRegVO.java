...
public class MbrRegVO extends ComDefaultListVO{
    ...
    /* [약관]관련 금투사약관동의(spt_customer_company_terms_profile)테이블 */
    private List<MbrRegTermsVO> companyTermsList;
    private List<String> companyTermsTypeList;
    private List<String> companyTermsAuthYnList;
    ...
    private String customerVerifyDn;
  	...
  	private String customerAuthNameKor;
  	private String customerAuthVerify;
	...
	public String getCustomerAuthPhone() {
		return customerAuthPhone;
	}
	public void setCustomerAuthPhone(String customerAuthPhone) {
		this.customerAuthPhone = customerAuthPhone;
	}
	public String getCustomerAuthNameKor() {
		return customerAuthNameKor;
	}
	public void setCustomerAuthNameKor(String customerAuthNameKor) {
		this.customerAuthNameKor = customerAuthNameKor;
	}
	public String getCustomerAuthVerify() {
		return customerAuthVerify;
	}
	public void setCustomerAuthVerify(String customerAuthVerify) {
		this.customerAuthVerify = customerAuthVerify;
	}
	...
	public List<MbrRegTermsVO> getCompanyTermsList() {
		return companyTermsList;
	}
	public void setCompanyTermsList(List<MbrRegTermsVO> companyTermsList) {
		this.companyTermsList = companyTermsList;
	}
	public List<String> getCompanyTermsTypeList() {
		return companyTermsTypeList;
	}
	public void setCompanyTermsTypeList(List<String> companyTermsTypeList) {
		this.companyTermsTypeList = companyTermsTypeList;
	}
	public List<String> getCompanyTermsAuthYnList() {
		return companyTermsAuthYnList;
	}
	public void setCompanyTermsAuthYnList(List<String> companyTermsAuthYnList) {
		this.companyTermsAuthYnList = companyTermsAuthYnList;
	}
