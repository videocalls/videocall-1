   ...
   /**
    ...
    public List<SptCustomerServiceTermsFileProfileVO> selectSptCustomerServiceTermsFileProfileList(SptCustomerServiceTermsFileProfileVO paramVO) throws Exception{
        ...
        if(!OppfStringUtil.isEmpty(termsFileType)){
            paramVO.setSearchTermsFileType(termsFileType);
        }
        
        String termsFileRegNo = paramVO.getTermsFileRegNo();
        if(!OppfStringUtil.isEmpty(termsFileRegNo)){
            paramVO.setSearchTermsFileRegNo(termsFileRegNo);
        }
    ...
    public SptCustomerServiceTermsFileProfileVO selectSptCustomerServiceTermsFileProfile(SptCustomerServiceTermsFileProfileVO paramVO) throws Exception{
        ...
        SptCustomerServiceTermsFileProfileVO result = cmmTsaDAO.selectSptCustomerServiceTermsFileProfile(paramVO);
        return result;
    }
  /**
