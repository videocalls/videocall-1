...
public class FixQueueManageVO extends ComDefaultListVO {
    ...
    * */
    ...
    private String afterInitServerId;
    ...
    public String getAfterInitServerId() {
        return afterInitServerId;
    }

    public void setAfterInitServerId(String afterInitServerId) {
        this.afterInitServerId = afterInitServerId;
    }
}
