                ...
                <div class="con">
                    ...
                    <div class="info_wrap">
                        ...
                        <ul class="info_step">
                            ...
                            <li><div><img src="<c:url value="/images/spt/info/icon_info_step4.png"/>" alt=""><p>핀테크앱 선택</p></div></li>
                            <li><div><img src="<c:url value="/images/spt/info/icon_info_step2.png"/>" alt=""><p>인증서등록/<br>정보제공동의</p></div></li>
                            <li><div><img src="<c:url value="/images/spt/info/icon_info_step3.png"/>" alt=""><p>가상계좌<br>발급/연결</p></div></li>
                            <li><div><img src="<c:url value="/images/spt/info/icon_info_step5.png"/>" alt=""><p>핀테크앱 이용</p></div></li>
                        </ul>
                        ...
                        <ul class="list_type01 type2">
                            ...
                            <li>선택된 핀테크 기업(핀테크 앱 개발사)에 금융거래정보 제공을 위한 동의가 필요합니다. <br>동의는 전자서명(공인인증서 인증), ARS 인증 중 선택 가능합니다.
