...
$(document).ready(function(){
    ...
    $("#btnIdLogin").bind("click", function(){
    	fn_moveHttpsUrl("<c:url value='/spt/cmm/loginView.do'/>");
    });
...
function fn_idFind(){
	...
	var moveUrl = "<c:url value='/spt/cmm/selectIdFind.ajax'/>";
...
function fn_idFindCallBack(data){
	...
	if(result != null){		
		...
		if(tabId == "id"){
			$("#li03").attr("class", "on");
			$("#resultId").html(result.customer_id);	        
	        $("#tab03").show();	
		}else{
			$("#li04").attr("class", "on");
