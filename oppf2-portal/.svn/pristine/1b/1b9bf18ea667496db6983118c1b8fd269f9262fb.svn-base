...
import kr.co.koscom.oppf.apt.simul.service.impl.SimulatormanageServiceImpl;
...
public class SimulatorManageController {
    private static final Logger log = Logger.getLogger(SimulatormanageServiceImpl.class);
