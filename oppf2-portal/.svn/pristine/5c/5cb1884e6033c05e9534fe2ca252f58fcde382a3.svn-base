...
function fn_ajaxCallback_getList(data){
    ...
    $.each(rsList, function(idx,data){        
        ...
        apData += '<tr>'               
                ...
                +   '</td>'
                +   '<td>' //별칭
                +     '<input type="text" name="customerVtaccountAlias" id="customerVtaccountAlias_'+idx+'" value="'+data.customerVtaccountAlias+'" title="별칭 입력" style="width:140px;" />'
            ...
            <article id="content">
                ...
                <div class="con">
                    ...
                    <div class="btn_area type2">
                        <div class="right">
                            <a href="javascript:void(0);" class="btn_type7" onclick="javascript:util_movePage('<c:url value='/usr/svcAppl/asumAcntIsu.do'/>?paramMenuId=06001');">
                                                                가상계좌 추가 발급
                            </a>
                        </div>
                    </div>
