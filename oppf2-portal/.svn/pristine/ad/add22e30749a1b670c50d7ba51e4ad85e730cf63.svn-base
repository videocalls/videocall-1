            ...
            <section class="content">
                ...
                <div class="tb_write1">
                    <table>
                        ...
                        <tr>
                            <th scope="row"><label for="t3">Body
                                <a href="#layer01" id="layer_open"><font style="color:red;">?</font>
                                </label></th>
                            <td class="txt_l">
...
<div class="layer_popup">   
    ...
    <div class="layer_box" id="layer01" style="width:620px;"><!-- 가로크기 직접제어, 세로는 최대 500px -->
        <div class="layer_tit">Body 등록 방법</div>

        <div class="">
<pre class="layer_con" style="font-size:12px">
정확한 비교를 위해서는 body 항목도 Key:Value 형식으로 등록하여야 합니다.
다음과 같아 하위 object 가 존재할 경우 예시입니다.
