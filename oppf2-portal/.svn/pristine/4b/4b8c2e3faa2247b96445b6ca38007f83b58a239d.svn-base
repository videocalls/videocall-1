...
public class OppfSessionUtil {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(OppfSessionUtil.class);
	...
	public static String getSystemKind(HttpServletRequest request){
		String systemKind = (String) request.getSession().getAttribute("SYSTEM_KIND");	//system kind를 가져온다.
