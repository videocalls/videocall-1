...
<script type="text/javascript" src="<c:url value='/js/spt/common_pub.js'/>"></script>
...
$(document).ready(function(){
    ...
    $("#btnIdLogin").bind("click", function(){
    	util_movePage("<c:url value='/apt/cmm/loginView.do'/>");
    });
...
function fn_idFind(){
	...
	var moveUrl = "<c:url value='/apt/cmm/selectIdFind.ajax'/>";
	//var param = $("#AptLoginVO").serialize();
...
function fn_PwFind(){
    ...
    var moveUrl = "<c:url value='/apt/cmm/selectPwFind.ajax'/>";
    //var param = $("#AptLoginVO").serialize();
    var param = new Object();
...
function fn_idFindCallBack(data){
	...
	if(result != null){		
		...
		if(tabId == "id"){
			$("#li03").attr("class", "on");
			$("#resultId").html(result.admin_id);
	        $("#tab03").show();
		}else{
			$("#li04").attr("class", "on");
			$("#resultEmail").html(result.admin_email);
            $("#tab04").show();
		}
	}else{
		if(tabId == "id"){
...
<div class="wrap">
    <form:form commandName="AptLoginVO" name="AptLoginVO" method="post">
                    ...
                    <div id="findTb">
	                    ...
	                    <div class="tab_cont" id="tab01">                       
	                        ...
	                        <div class="idpw_search_box">
	                            ...
	                            <ul class="idpw_box">
	                                <li><label for="user_name">이름</label><input type="text" name="searchIdName" id="searchIdName" class="input_txt01"  style="min-width:238px;" tabindex="1"></li>
	                                <li>
	                                    <label for="user_email">이메일 주소</label><input type="text" name="searchIdEmail_01" id="searchIdEmail_01" class="input_txt01" style="min-width:148px;" tabindex="2">
	                                    <span class="dot">@</span><input type="text" name="searchIdEmail_02" id="searchIdEmail_02" class="input_txt01" style="min-width:188px;" tabindex="2">
	                    ...
	                    <div class="tab_cont" id="tab02">                        
	                        <div class="idpw_search_box">
	                            ...
	                            <ul class="idpw_box">
	                                <li><label for="user_name2">이름</label><input type="text" name="searchPwName" id="searchPwName" class="input_txt01"  style="min-width:238px;"></li>
	                                <li><label for="user_id">아이디</label><input type="text" name="searchPwId" id="searchPwId" class="input_txt01"  style="min-width:238px;"></li>
	                                <li>
	                                    <label for="user_email2">이메일 주소</label><input type="text" name="searchPwEmail_01" id="searchPwEmail_01" class="input_txt01" style="min-width:148px;">
	                                    <span class="dot">@</span><input type="text" name="searchPwEmail_02" id="searchPwEmail_02" class="input_txt01" style="min-width:188px;">
	                                    <span class="sel_box1 type2">
                    ...
                    <div id="resultTb">
	                    ...
	                    <div class="tab_cont" id="tab03">
	                        <div class="id_search_area">
	                            <div class="tit_info">
	                                <img src="<c:url value='/images/spt/members/icon_tit_info03.png'/>" alt="">
	                                <p>
	                                    <span>아이디 찾기 결과</span>
