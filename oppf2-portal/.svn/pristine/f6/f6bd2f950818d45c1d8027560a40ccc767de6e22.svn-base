	...
	<h2 class="logo"><a href="#none"><img src="/images/spt/common/logo_m.png" alt="Koscom OpenAPI Platform"></a></h2>
		...
		<div class="account">
			<div class="tit_info font16">
				...
				<div class="logo_img"><img src="<c:url value=""/><c:out value='${ appImg }'/>" onerror="this.src='<c:url value="/images/cmm/icon/icon_app_none.png"/>'" alt="<c:out value='${ paramVO.app_name }'/>"></div>
				<div class="biz_name"><span><c:out value='${ paramVO.app_name }'/></span>(<c:out value='${ paramVO.companyName }'/>)</div>
			</div>
			<div class="scl_box">
				<div class="txt">
					<ul>
			...
			<p class="txt_b mt20">* 허용을 클릭하시면 <span><c:out value='${ paramVO.app_name }'/></span>에서 회원님의 정보를 사용하도록 허용하게 됩니다.</p>
			<div class="btn_area radius_type">
