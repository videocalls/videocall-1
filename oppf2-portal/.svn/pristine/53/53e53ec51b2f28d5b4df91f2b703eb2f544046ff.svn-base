...
public class CmmOtpReqDAO extends ComAbstractDAO{
    ...
    private static final Logger log = Logger.getLogger(CmmOtpReqDAO.class);
      ...
      * @throws             : Exception
      */
     public int updateOtpProfileDev(CmmOtpReqVO cmmOtpReqVO) throws Exception{
         return update("cmm.CmmOtpReqDAO.updateOtpProfileDev", cmmOtpReqVO);
     }
      ...
      * @throws             : Exception
      */
     public int deleteOtpProfileDev(CmmOtpReqVO cmmOtpReqVO) throws Exception{
         return update("cmm.CmmOtpReqDAO.deleteOtpProfileDev", cmmOtpReqVO);
     }
