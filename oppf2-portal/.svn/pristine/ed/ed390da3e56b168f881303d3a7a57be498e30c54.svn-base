                ...
                <div class="tb_write1">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="txt_l">
                                <select title="구분 입력" id="noticeKind" name="noticeKind">
                                <c:forEach items="${noticeKindList}" var="noticeKindList" varStatus="status">
                                    <option value="${noticeKindList.system_code}"
                                        <c:if test="${resultDetail.noticeKind eq noticeKindList.system_code}"> selected="selected" </c:if>
                                    >${noticeKindList.code_name_kor}</option>
                                </c:forEach>
                            </td>                  
                        </tr>
