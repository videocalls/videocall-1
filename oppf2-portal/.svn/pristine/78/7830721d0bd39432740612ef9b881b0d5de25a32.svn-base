...
public class IntAcntController {
    ...
    //AssetType All 이 지원되는 증권사 코드 리스트
    String allAssetCompanys = OppfProperties.getProperty("Globals.integrated.account.allCompany");
    //핀테크 기업 코드
    ...
    //통합계좌 apiKey
    String apiKey = OppfProperties.getProperty("Globals.integrated.account.apiKey");
    ...
    */
    ...
    private String selectBalance(@ModelAttribute("IntAcntSearchVO") IntAcntSearchVO paramVO,
        ...
        if(successCount > 0){
            ...
            for(Object o : inteGratedAccountResponseVO.getResultList()){
        ...
        for(VtAccountVO vtAccountVO : vtAccountListVO.getVtAccList()){
            ...
            try{
                ...
                String payload = "{ \"partner\" : { \"comId\": \""+comId+"\",  \"srvId\": \""+srvId+"\"}," +
                        ...
                        " \"devInfo\" : { \"ipAddr\": \""+tmpIpAddr+"\",  \"macAddr\": \""+macAddr+"\"}," +
                        " \"accInfo\" : { \"vtAccNo\": \"" + vtAccNo + "\"}," +
                        " \"transactionHistoryRequestBody\" : { \"queryParams\" : { \"fromDate\": \""+fromDate+"\", \"toDate\": \""+toDate+"\", \"isinCode\": \""+paramIsinCode+"\", \"side\": \""+side+"\", \"count\":100}}}";
                //상용모드:개발모드
