...
function fn_SchConfrm(){
    ...
    var url = "<c:url value='/cpt/myp/cptMyInfo/checkPwProcs.ajax'/>";
    
    //로딩start
    gfn_setLoading(true, "비밀번호 확인 중입니다.");
    
    var objParam = new Object();
    objParam.operatorId = $("#userId").val();
    objParam.companyProfileRegNo = $("#companyProfileRegNo").val();
    objParam.operatorProfileRegNo = $("#operatorProfileRegNo").val();
    objParam.operatorPassword = $("#userPw").val();
//    objParam.operatorPassword = spw;
