...
<%--
/**  
 * @Name : sptWithdrawUserManageList.jsp
 * @Description : 탈퇴회원관리 목록
...
<%-- 로그인 처리 공통 함수 --%>
function fn_login(){
    var url = "<c:url value='/apt/sptUsr/sptWithdrawUserManageList.do'/>";
...
/* 		if(util_chkReturn($.trim($('#searchDateTo').val()), "s") != "") {
    ...
    $("#btnSearchClear").click(function(){
        ...
        //$("#searchWithdrawalProc").val("<c:out value='${SptUserManageVO.searchCondition}'/>");
        ...
        util_moveRequest("SptUserManageVO", "<c:url value='/apt/sptUsr/sptWithdrawUserManageList.do'/>", "_top");
    ...
    gfn_gridOption('jqxgrid',{    
		columns: [
            ...
            { text: '탈퇴처리', datafield: 'customerWithdrawalProc', width: '10%', cellsalign: 'center', align: 'center' },
...
function fn_search(pageIndex){
	...
	//page setting  
    var url = "<c:url value='/apt/sptUsr/selectSptWithdrawUserManageList.ajax'/>";
...
function fn_searchExcel(excelType){
    ...
    util_moveRequest("SptUserManageVO", "<c:url value='/apt/sptUsr/sptWithdrawUserManageListExcel.do'/>", "EXCEL_FRAME");
...
function fn_moveDetail(data){
	...
	util_moveRequest("SptUserManageVO", "<c:url value='/apt/sptUsr/sptWithdrawUserManageDtl.do'/>", "_top");
	//sptWithdrawUserManageDtl	
}
            ...
            <section class="content">
                ...
                <div class="tb_write1">
                    <table>
                        ...
                        <tr>
                            <th scope="row"><label for="searchWithdrawalProc">탈퇴 처리</label></th>
                            <td class="txt_l"> 
                                <select title="탈퇴 처리 여부 입력" id="searchWithdrawalProc" name="searchWithdrawalProc">
                                    <option value="all">전체</option>
