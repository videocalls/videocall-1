...
function fn_PwChange(){
    ...
    if( confirm(msgConfirm) ){
    	var url = "<c:url value='/spt/myp/sptMyInfo/updateSptMyPwMod.ajax'/>";
    	var userId = $("#userId").val();
    	
    	var objParam = new Object();
        objParam.customerId = userId;
        objParam.customerPassword = userNewPw; 
...
$(document).ready(function(){
    ...
    $("#btnNextChange").bind("click", function(){    	
    	parent.window.location.href = "<c:url value='/spt/myp/sptMyInfo/sptMyPwModNextChange.do'/>";
    	window.close();
    });
