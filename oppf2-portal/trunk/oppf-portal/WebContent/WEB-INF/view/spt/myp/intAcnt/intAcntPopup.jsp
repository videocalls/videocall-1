...
function fn_login(){
     ...
     g_verifyWin = window.open('', winName, 'width=560, height=435, top=100, left=100, fullscreen=no, menubar=no, status=no, toolbar=no, titlebar=yes, location=no, scrollbar=no');
