...
/*                 if(util_chkReturn($.trim($('#searchDateTo').val()), "s") != "") {
        ...
        function fn_beforServerStop(data){
            if(confirm("수정하시겠습니까?")){
                ...
                param.afterInitServerId = $("#hub_" + data.fixQueueId + " option:selected").val();
                param.initServerIp = data.initServerIp;
                param.afterInitServerIp = $("#hub_" + data.fixQueueId + " option:selected").text();
