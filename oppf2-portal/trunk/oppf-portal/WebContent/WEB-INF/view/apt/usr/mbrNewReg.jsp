...
function fn_validate(){
    ...
    var customerDatasetLockYn = $("#customerDatasetLockYn").val(); // 데이터셋 잠금 여부
    ...
    $("#customerDatasetLockYn").val(customerDatasetLockYn);					// 공인인증서 등록 약관동의
                ...
                <div class="tb_write1">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="txt_l" colspan="3">
                                <input type="password" name="customerPassword1" id="customerPassword1" style="width:238px;" maxlength="15" placeHolder="ex)Qetu101!@"  value="<spring:message code='common.create.member.default.pwd'/>"/>
                                <span class="info_msg">8~15자의 영문 대/소문자, 숫자, 특수문자 중 3개 이상의 조합</span>
                                <input type="hidden" name="customerPassword" id="customerPassword"  value="<spring:message code='common.create.member.default.pwd'/>"/>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row" colspan="2">
                            ...
                            <td class="txt_l" colspan="3">
                                <input type="password" name="customerPassword2" id="customerPassword2" style="width:238px;"  maxlength="15"  value="<spring:message code='common.create.member.default.pwd'/>"/>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row" colspan="2">계정 유형</th>
                            <td class="txt_l">회원</td>
                            <th scope="row">가입구분</th>
                            <td class="txt_l">WEB</td>                 
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th scope="row" colspan="2">데이터셋 잠금 여부</th>
                            <td class="txt_l" colspan="3">
