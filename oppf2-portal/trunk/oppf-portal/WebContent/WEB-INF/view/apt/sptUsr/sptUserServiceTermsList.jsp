 ...
 * 전역 변수
 *******************************************/
var g_initCheckboxArr = ["searchMemberTemporary","searchSubcompanyCodeId","searchPubcompanyCodeId","searchTermsStatus","termsAuthTypeList"];
...
/* 		if(util_chkReturn($.trim($('#searchDateTo').val()), "s") != "") {
    ...
    gfn_gridOption('jqxgrid',{    
		columns: [
            { text: '앱개발자', datafield: 'subcompanyCodeName', width: '15%', cellsalign: 'left', align: 'center' },
            { text: 'App. 이름', datafield: 'appName', width: '15%', cellsalign: 'left', align: 'center' },
