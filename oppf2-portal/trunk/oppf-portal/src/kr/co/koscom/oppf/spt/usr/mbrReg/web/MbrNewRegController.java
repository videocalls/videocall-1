...
public class MbrNewRegController {
    ...
    private String mbrReg2(
    		@ModelAttribute MbrRegVO paramVO
       ,HttpServletRequest request
       ,ModelMap model
    )throws Exception{
...
//  회원가입 스텝별 유효성 검증
    ...
    private String mbrNewReg2(
       ...
       ,ModelMap model
        ...
        String customerRegNo = mbrRegService.createMember(paramVO);
 ...
 //  회원가입 스텝별 유효성 검증
    ...
    private String mobileCheckAuth(
        @ModelAttribute("mbrRegVO") MbrRegVO paramVO
       ,HttpServletRequest request
       ,ModelMap model
    )throws Exception{
    ...
    private String chkMbrCiChkForUpdate(
        @ModelAttribute("mbrRegVO") MbrRegVO paramVO, HttpServletRequest request ,ModelMap model)throws Exception{
