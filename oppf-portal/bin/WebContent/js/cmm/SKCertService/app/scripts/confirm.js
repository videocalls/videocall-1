...
var confirm = (function (doc, $, vest, params, vestSign) {
    ...
    $(document).ready(function () {
        ...
        if(typeof(_config.msg) !== 'string'){
            _msg = confirmMsg[_config.msg];
            _msg += (typeof(_param.option.certificateSubject) == 'undefined') ? '' : _param.option.certificateSubject;
        }
        else {
            _msg = _config.msg;
        }
        //$("#dialogCertMsg_text").val(_config.msg);
        $("#dialogCertMsg_text").val(_msg);
        $("#dialogCertMsg_text").attr('title', _msg);
