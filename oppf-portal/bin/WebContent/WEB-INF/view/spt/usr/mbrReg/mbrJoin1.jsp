...
function fn_checkCi(sex, birthDay, smobileNo, sname, ci) {
	...
	*/
	...
	$("#customerPhone").val(smobileNo);
	$("#customerNameKor").val(sname);
...
function fn_createMember() {
    ...
    objParam.customerPhone = $("#customerPhone").val();
    objParam.customerNameKor = $("#customerNameKor").val();
...
<div class="wrap">
    ...
    <section>
        ...
        <form:form commandName="MbrRegVO" name="MbrRegVO" method="post">
        	...
        	<input type="hidden" name="customerNameKor" id="customerNameKor" value="" />
