...
<%@ page import="kr.co.koscom.oppf.cpt.myp.stats.service.CptStatsTrafficVO" %>
<%@ include file="/WEB-INF/view/cmm/common-include-doctype.jspf" %>
<%  
    CptStatsTrafficVO paramVO = (CptStatsTrafficVO) request.getAttribute("paramVO");
    ...
    String filename = java.net.URLEncoder.encode("APP트래픽통계["+searchTrafficType+"기준]_"+date+".xls","UTF-8");
    //다운로드하고자 한다면 
...
<%--
/**  
 * @Name : statsTrafficAppListExcel.jsp
 * @Description : APP트래픽통계 excel 조회 목록
