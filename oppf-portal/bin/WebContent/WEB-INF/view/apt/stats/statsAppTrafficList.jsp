...
<%-- 로그인 처리 공통 함수 --%>
function fn_login(){
    var url = "<c:url value='/apt/stats/statsAppTrafficList.do'/>";
...
function fn_changeAppNameList(){
    ...
    //page setting
    var url = "<c:url value='/apt/stats/statsAppTrafficChangeAppNameList.ajax'/>";
    var param = $("#StatsTrafficVO").serialize();
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="txt_l" colspan="3">
                                    ...
                                    <input type="radio" id="searchStatsTypeApiServiceName" name="searchStatsType" value="apiName" /><label for="searchStatsTypeApiServiceName"> API 서비스 이름 </label>
