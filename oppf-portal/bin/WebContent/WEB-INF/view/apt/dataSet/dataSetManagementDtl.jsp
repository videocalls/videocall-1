        ...
        $(document).ready(function(){
            ...
            gfn_gridOption('tran_transactionGrid',{
                ...
                columns: [
                    ...
                    { text: '잔고수량', datafield: 'changeQuantity', width: '12%', cellsalign: 'right', align: 'center', cellsformat: 'n'},
                    { text: '거래구분', datafield: 'transType', width: '12%', cellsalign: 'left', align: 'center' },
                    { text: '금액증감', datafield: 'changeAmt', width: '12%', cellsalign: 'right', align: 'center', cellsformat: 'n' },
