...
$(document).ready(function(){
    var serverType = "<spring:message code='Globals.server.type' />";    
    var topCss = "";

    if( serverType == 'dev') {
        topCss = "bg_black";
    } else if( serverType == 'send') {
        topCss = "bg_org";
    } else if( serverType.indexOf('oppr') > -1) {
        topCss = "bg_blue";
    }
    
    $("#top_header").addClass(topCss);
});
</script>

<!-- bg_black / bg_org / bg_blue -->
<header id="top_header" class="wrap_top">
    <div>
        <h1>
