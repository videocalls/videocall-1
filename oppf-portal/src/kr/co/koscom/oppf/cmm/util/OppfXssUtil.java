...
public class OppfXssUtil {
    ...
    public static Pattern [] scriptPtn = {
            ...
            Pattern.compile("(case)", Pattern.CASE_INSENSITIVE | Pattern.DOTALL) };
    
    /**
     * 스크립트 문자열을 치환할 문자열
     */
    public static String [] scriptPtnChng = new String[] {"sklibt", "zabasklibt", "ksklibt", "m\\$sklibt", "zlert", "kase"};
