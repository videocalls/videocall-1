...
public class FaqManageController {
    ...
    private String faqManageList(@ModelAttribute("FaqManageVO") FaqManageVO paramVO, HttpServletRequest request, ModelMap model)throws Exception{
        ...
        cmmFuncVO.setSystem_grp_code("G045");
        List<CmmFuncVO> displayServerTypeList = cmmFuncService.selectCmmnFuncCode(cmmFuncVO);
        model.addAttribute("displayServerTypeList", displayServerTypeList);
