...
public class CmmEmailSendDAO extends ComAbstractDAO{
    ...
    public List<CmmEmailCronSvcTermsVO> selectCronCommonTermsList() throws Exception{
        return (List<CmmEmailCronSvcTermsVO>) list("cmm.CmmEmailSendDAO.selectCronCommonTermsList");
    }

    @SuppressWarnings("unchecked")
    public List<String> selectCronCommonTermsPubCompanyList(CmmEmailCronSvcTermsVO cmmEmailCronSvcTermsVO) throws Exception{
        return (List<String>) list("cmm.CmmEmailSendDAO.selectCronCommonTermsPubCompanyList", cmmEmailCronSvcTermsVO);
    }
}
