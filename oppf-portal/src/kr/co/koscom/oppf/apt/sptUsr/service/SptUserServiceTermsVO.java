...
public class SptUserServiceTermsVO extends ComDefaultListVO{
	...
	/* 조회조건 */
	//계정유형
	private List<String> searchMemberTemporary;
	private String searchMemberTemporaryAllYn;
	...
	public List<String> getSearchMemberTemporary() {
		return searchMemberTemporary;
	}
	public void setSearchMemberTemporary(List<String> searchMemberTemporary) {
		this.searchMemberTemporary = searchMemberTemporary;
	}
	public String getSearchMemberTemporaryAllYn() {
		return searchMemberTemporaryAllYn;
	}
	public void setSearchMemberTemporaryAllYn(String searchMemberTemporaryAllYn) {
		this.searchMemberTemporaryAllYn = searchMemberTemporaryAllYn;
	}
	public String getTemporaryMember() {
		return temporaryMember;
	}
	public void setTemporaryMember(String temporaryMember) {
