...
<%--
/**  
 * @Name : sptUserServiceListExcel.jsp
 * @Description : 서비스 연결 현황 excel 목록
...
<%  
    ...
    String filename = java.net.URLEncoder.encode("서비스연결현황_"+date+".xls","UTF-8"); 
    //다운로드하고자 한다면 
   ...
   <table border="1">
       ...
       <c:choose>
           <c:when test="${empty resultList}" >
               <tr>
                  <td colspan="15" align="center">조회 된 데이터가 없습니다.</td>
               </tr>
           </c:when>
           <c:otherwise>
               <c:forEach var="resultList" items="${resultList}" varStatus="status">
                   <tr>  
                       <td class="txt_l" align="left"><c:out value='${resultList.serviceRegNo}'/></td>
                       <td class="txt_l" align="center"><c:out value='${resultList.svcAvailableYnName}'/></td>
                       ...
                       <td class="txt_l" align="center"><c:out value='${resultList.temporaryMember}'/></td>
