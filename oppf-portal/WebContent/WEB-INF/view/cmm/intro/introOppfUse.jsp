            ...
            <article id="content">              
                ...
                <div class="con">
                    <div class="info_wrap">
						...
						<p class="info_tit2">참조문서</p>
                        <ul class="list_type01 type2">
                            <li><a href="https://developers.koscom.co.kr/resources/documentation/20170703_OpenAPI_Platform_Service_Guide_for_Fintech_Company.hwp"><FONT COLOR=“#0000FF”>오픈API플랫폼 서비스 이용안내 (hwp)</FONT></a></li>
                        </ul>
                        ...
                        <ul class="info_step3">
                            ...
                            <li class="step2"><div><strong>서비스 테스트 및 기술 검증</strong><p><span>코스콤 핀테크 테스트베드 센터<br>개발을 위한 Sandbox 플랫폼<br>계정 발급</span></p></div></li>
                        ...
                        <ul class="list_type01 type2">
                            <li>코스콤 핀테크플랫폼팀 김동범 차장 : (02) 767-7913, imaro@koscom.co.kr</li>
                        </ul>
