...
# Date: 2017-07-05 10:43:15
# Generator: MySQL-Front 5.4  (Build 4.71) - http://www.mysqlfront.de/

/*!40101 SET NAMES utf8 */;

#
# Event "adm_api_traffic_event_daily"
#

DROP EVENT IF EXISTS `adm_api_traffic_event_daily`;
CREATE EVENT `adm_api_traffic_event_daily` ON SCHEDULE EVERY 1 DAY STARTS '2016-07-12 03:05:00' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
    /*
    ...
    */
    ...
    set v_std_date = date_format(subdate(now(), INTERVAL 1 DAY), '%Y%m%d');
