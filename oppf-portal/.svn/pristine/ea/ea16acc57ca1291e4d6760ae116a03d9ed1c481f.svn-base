...
public class NotiManageVO extends ComDefaultListVO{
	...
	private String displayServerType;  //노출서버 타입
	 ...
	 * 검색조건
	 */
	private String searchDisplayServerType; //노출서버 타입
	...
	public String getDisplayServerType() {
		return displayServerType;
	}
	public void setDisplayServerType(String displayServerType) {
		this.displayServerType = displayServerType;
	}
	public String getSearchDisplayServerType() {
		return searchDisplayServerType;
	}
	public void setSearchDisplayServerType(String searchDisplayServerType) {
		this.searchDisplayServerType = searchDisplayServerType;
	}
}