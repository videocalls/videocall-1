...
public class NewMbrRegServiceImpl implements NewMbrRegService {
	...
	public int saveNewMbrReg(NewMbrRegVO paramVO) throws Exception {
		...
		termsVO.setCustomerSignDn(CodeConstants.TEST_PROFILE_MESSAGE);
		//termsVO.setCustomerSignDn("본 동의서는 테스트용입니다.");
		termsVO.setCustomerSignData(CodeConstants.TEST_PROFILE_MESSAGE);
		//termsVO.setCustomerSignData("본 동의서는 테스트용입니다.");
		createCommonTermsTestMember(termsVO);
    ...
    /**
     * @Method Name        : createCommonTermsTestMember
     * @Method description : 테스트회원 가동의서 처리
     * @param              : 
     * @return             : 
     * @throws             : 
     */
    @Override
    @Transactional
    public String createCommonTermsTestMember(TermsVO termsVO) throws Exception {
        ...
        if(commonTerms != null) {
        	...
        	commonTerms.setCustomerSignDn(CodeConstants.TEST_PROFILE_MESSAGE);
        	commonTerms.setCustomerSignData(CodeConstants.TEST_PROFILE_MESSAGE);
        ...
        this.createTermsFileTestMember(termsVO);
    ...
    @Transactional
    private void createTermsFileTestMember(TermsVO paramVO) throws Exception{
        ...
        //9.TSA연동後결과값세팅
        String dataHash = CodeConstants.TEST_PROFILE_MESSAGE; 
        //"본 동의서는 테스트용입니다.";
...
//                    log.debug("fileNameRep["+i+"]="+fileNameRep);
	...
	public HashMap<String, Object> procTsa(CmmTsaVO paramVO) throws Exception {
		...
		pScstpVO.setCustomerTsaData(CodeConstants.TEST_PROFILE_MESSAGE);
