...
$(document).ready(function(){
	...
	fn_search($("#searchTermsCode option:selected").val());
});
    ...
    <section>
        ...
        <div class="container">
            ...
            <div class="certi_wrap">
                ...
                <p class="certi_txt">금융투자 핀테크 포털 서비스 이용약관</p>
                
				<div class="textboxwrap_service_privercy2">
					<div class="intextboxwrap" tabindex="0">
						<span id="privercy_txt" style="display: block;">
							<c:out value="${introVO.customerTermsContent}" escapeXml="false" />
						</span>
					</div>
				</div>	                
	        </div>
            ...
            <div class="certi_wrap">
                <p class="certi_txt">
                    <span class="fl">금융투자회사 이용약관</span>
                ...
                <textarea id="termsContent" class="service_privercy_txt2" readonly="readonly" onclick="javascript:void(0);"><c:out value='${introVO.customerTermsContent}'/></textarea>
