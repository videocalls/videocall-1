...
var setCheckFailText2 = '<a id="aSignDown" class="download" href="<c:url value='/js/cmm/SKCertService/SKCertServiceSetup_v2.5.5_254.exe'/>" title="공인인증 프로그램 설치 링크">다운로드</a>';
...
//     }
    ...
    CertManX.CertServiceSetup(function(result){
        if(result == ""){
            ...
            if(errorCode == 90000){
            	location.href="<c:url value='/js/cmm/SKCertService/SKCertServiceSetup_v2.5.5_254.exe'/>";
            }
...
<!--                                         <a class="download" href="http://kiwoom-dn-cdn.daouidc.com/SKCertServiceSetup_v2.1.4_r2634.exe" title="공인인증 프로그램 설치 링크"> -->
                                <a id="aSignDown" class="download" href="<c:url value='/js/cmm/SKCertService/SKCertServiceSetup_v2.5.5_254.exe'/>" title="공인인증 프로그램 설치 링크">
                                                                            다운로드
                                </a>
                            </td>
                        </tr>
