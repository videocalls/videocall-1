...
public class SvcApplServiceImpl implements SvcApplService{
    ...
    public SptCustomerCompanyTermsProfileVO selectSvcMemberCompanyTermsConsntList(SvcApplVO svcApplVO) throws Exception{
        return (SptCustomerCompanyTermsProfileVO) svcApplDAO.selectSvcMemberCompanyTermsConsntList(svcApplVO);
    }
  ...
  /**
    ...
    */
    ...
    public int saveMemberCompanyTermsConsnt(SptCustomerCompanyTermsProfileVO sptCustomerCompanyTermsProfileVO) throws Exception{
        int result = -1;
        String companyTermsType = "G031001";		//기업 서비스 이용약관
        sptCustomerCompanyTermsProfileVO.setCompanyTermsType(companyTermsType);
        /**
         * 1. 기업약관 정보 확인
         * 2. 기업약관 정보 등록 or 수정
         */
		...
		//기본정보 셋팅
		sptCustomerCompanyTermsProfileVO.setCompanyTermsType(companyTermsType);
		sptCustomerCompanyTermsProfileVO.setCompanyTermsAuthYn("Y");
		
		//1. 기업약관 정보 확인
		int cnt = svcApplDAO.checkSptCustomerCompanyTermsProfile(sptCustomerCompanyTermsProfileVO);
		
		//기존에 있으면 update
		if(cnt > 0){
			result = svcApplDAO.updateSptCustomerCompanyTermsProfile(sptCustomerCompanyTermsProfileVO);
			
	    //있으면 insert
		}else{
			result = svcApplDAO.insertSptCustomerCompanyTermsProfile(sptCustomerCompanyTermsProfileVO);
		}
		
		//hist insert
		result = svcApplDAO.insertSptCustomerCompanyTermsProfileHist(sptCustomerCompanyTermsProfileVO);
