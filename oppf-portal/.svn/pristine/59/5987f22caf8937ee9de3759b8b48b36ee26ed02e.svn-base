...
public class BalanceResponseViewVO {
	...
	private MsgResponseBodyVO balanceResponseBody = new MsgResponseBodyVO();
	...
	public MsgResponseBodyVO getBalanceResponseBody() {
		return balanceResponseBody;
	}
	public void setBalanceResponseBody(MsgResponseBodyVO balanceResponseBody) {
